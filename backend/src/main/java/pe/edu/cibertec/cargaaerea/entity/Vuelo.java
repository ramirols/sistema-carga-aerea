...
public class Vuelo {
	...
	@Column(name = "codigo_aeropuerto_origen", nullable = false, length = 3)
	private String codigoAeropuertoOrigen;
	@Column(name = "codigo_aeropuerto_destino", nullable = false, length = 3)
	private String codigoAeropuertoDestino;
	@Column(name = "terminal_carga_destino", length = 80)
	private String terminalCargaDestino;
